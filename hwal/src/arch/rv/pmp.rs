...
pub const fn pmp_cfg_mask(id: usize) -> u32 {
    pmp_cfg_enc(id, 0xff)
}

pub const fn pmp_cfg_enc(id: usize, value: u8) -> u32 {
    (value as u32) << ((id & 0x3) << 3)
}

pub const fn pmp_addr_na(addr: usize, size: usize) -> u32 {
